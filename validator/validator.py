...
class NodeValidator():
    REGULAR_DIRECTORY_PATH = '/github/home/DIRECTORY_REGULAR.md'
    ...
    def get_validation(self) -> ValidatorOutput:
        with open('/github/home/data/validator-nodes.json', 'r') as file:
            is_validator_valid=self.is_valid_json_file(file.read())
        with open('/github/home/data/constellation-nodes.json', 'r') as file:
            is_constellation_valid=self.is_valid_json_file(file.read())
        with open('/github/home/data/regular-nodes.json', 'r') as file:
